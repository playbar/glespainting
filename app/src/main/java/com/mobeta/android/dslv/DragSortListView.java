...
public class DragSortListView extends ListView {
     ...
     * <code>mAdapter</code>, this method calls the appropriate
     * set*Listener method with <code>mAdapter</code> as the argument.
     * 
     ...
     * mAdapter which does not have stable IDs (see
     ...
     * dealing with movable list items: for an mAdapter that <em>does</em> have
     ...
     * position, you may wish to use an mAdapter with unstable IDs and call this
     ...
     * underlying mAdapter which does not have stable IDs (see
     * {@link ListAdapter#hasStableIds()}). This is because without IDs, the
     * ListView has no way of knowing which items have moved where, and cannot
     * update the check state accordingly.
     * 
