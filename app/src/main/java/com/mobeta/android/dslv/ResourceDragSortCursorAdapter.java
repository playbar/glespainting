...
public abstract class ResourceDragSortCursorAdapter extends DragSortCursorAdapter {
     ...
     *
     * @param context The context where the ListView associated with this mAdapter is running
     ...
     * @param autoRequery If true the mAdapter will call requery() on the
     ...
     *            define both the item views and the drop down views.
     * @param c The cursor from which to get the data.
     * @param flags Flags used to determine the behavior of the mAdapter,
