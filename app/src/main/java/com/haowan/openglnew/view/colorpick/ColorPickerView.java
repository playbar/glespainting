...
package com.haowan.openglnew.view.colorpick;
...
//		drawAlphaPanel(canvas);//绘制底部透明度选择区域
	...
	private void drawSatValPanel(Canvas canvas){
		...
		if(BORDER_WIDTH_PX > 0){
			...
			canvas.drawRect(mDrawingRect.left+padding, mDrawingRect.top, rect.right + BORDER_WIDTH_PX, rect.bottom + BORDER_WIDTH_PX, mBorderPaint);
		}
		//明度线性渲染器
		if (mValShader == null) {
...
//		}
		...
		padding = (dRect.width() - panelSide - BORDER_WIDTH_PX * 2)/2;

		float left = dRect.left + BORDER_WIDTH_PX + padding;
